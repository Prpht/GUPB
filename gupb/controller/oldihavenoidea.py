...
class OldIHaveNoIdeaWhatImDoingController:
    def __init__(self):
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, OldIHaveNoIdeaWhatImDoingController):
            return True
        return False
    ...
    @property
    def name(self) -> str:
        return 'OldIHaveNoIdeaWhatImDoingController'
...
POTENTIAL_CONTROLLERS = [
    OldIHaveNoIdeaWhatImDoingController(),
]
