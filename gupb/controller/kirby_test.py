...
from gupb.controller.kirby import KirbyController
...
class KirbyTestController(KirbyController):
    def __init__(self, first_name: str = "KirbyTest"):
        super().__init__(first_name)

    def __eq__(self, other: object) -> bool:
        if isinstance(other, KirbyTestController):
